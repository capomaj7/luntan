...
<script type="text/javascript">
	...
	return true;
 	...
 	$(function(){
 		$("input[name='userSex'][value='${tu.sex}']").attr("checked",true);
 	});
</script>
	...
	<div align="center"
		...
		<p>
			<img alt="我的头像" style="width: 160px;height: 220px;"  onerror="this.src='./image/ds-java.png'" 
				src="${ctx }/${tu.picture}">
		<form action="uploadUserPic.action" enctype="multipart/form-data" method="POST" onsubmit="return uploadF();">
			<div align="right">
				...
				<input name="fileUpload" type="file" id="fu"
