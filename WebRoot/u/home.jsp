		...
		<div class="tBody">
			...
			<div class="userStyle">
				<div class="leftBodyNav" id="leftBodyNav">
					...
					<a href="user_GetTopics.action" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_2" onclick="javascript:test_item(2);">我的帖子</div>
					</a> 
					<a href="user_GetComments.action" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_3" onclick="javascript:test_item(3);">我的评论</div>
					</a>
					<a href="focus_GetFollowings.action" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_4" onclick="javascript:test_item(4);">我关注的人</div>
					</a>
					<a href="focus_GetFollowers.action" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_5" onclick="javascript:test_item(5);">关注我的人</div>
					</a>
					<a href="favor_GetFavors.action" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_6" onclick="javascript:test_item(6);">我收藏的帖子</div>
					</a> 
					<a href="u/updateInfo.jsp" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_7" onclick="javascript:test_item(7);">修改资料</div>
					</a> 
					<a href="u/updatePass.jsp" target="test1"
						onclick="return checkULogin()"><div class="leftBodyNavStyle"
							id="leftBodyNavStyle_8" onclick="javascript:test_item(8);">修改密码</div>
