...
public class Users {
	...
	//关注的帖子的集合,单向的一对多，不需要通过收藏的帖子知道收藏者是谁
	private Set<Favor>favors=new HashSet<Favor>();
	//关注人的集合
	private Set<Focus>focuspersons=new HashSet<Focus>();
	public int getId() {
		return id;
	}
	...
	public Set<Focus> getFocuspersons() {
		return focuspersons;
	}

	public void setFocuspersons(Set<Focus> focuspersons) {
		this.focuspersons = focuspersons;
	}
